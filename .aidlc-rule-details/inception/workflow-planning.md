---
codd:
  node_id: "doc:workflow-planning-en"
  type: document
  depends_on: []
---
...
## [CoDD] Step 8.5: Completion Gate

**MANDATORY — Run before presenting plan to user**:

```bash
# Step 1: Update dependency graph with planning artifacts
codd scan --path .
# → Registers execution-plan.md and other planning documents in the dependency graph

# Step 2: CoDD internal coherence check (primary gate — CoDD is the design authority)
codd validate
# → Exit 0: No issues — proceed to Step 9
# → Exit 1: Issues found — include warning summary in approval gate

# Step 3: Sync derived knowledge graph
/graphify --update
# → Syncs graphify-out/graph.json with planning artifacts (derived index)
```

**If `codd validate` exits 1** (issues detected), include the following warning block in the Step 9 approval message:
```
⚠️ CoDD Coherence Warning (codd validate result)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Issues detected:
  - [issue description] (severity: Amber/Gray)
